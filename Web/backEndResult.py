...
def returnDiseaseName(input_param):
    ...
    loaded_model = joblib.load("C:/Users/HRITHIMAN GUHA/Desktop/Robo Hackathon/ML Models/DiseaseM.joblib")
...
def returnDiseaseDescription(disease_name):
    dir_descip =("C:/Users/HRITHIMAN GUHA/Desktop/Robo Hackathon/Data/symptom_Description.csv")
    descip = get_row_by_value(dir_descip,"Disease",disease_name)

    return descip["Description"]
def returnDiseasePrecaution(disease_name):
    dir_precau = ("C:/Users/HRITHIMAN GUHA/Desktop/Robo Hackathon/Data/symptom_precaution.csv")
